    ...
    public static void main(String args[]) throws InterruptedException {
       ...
       if (args.length > 2) {
        ...
        IoTDevice device = new IoTDevice(serverUri, deviceId, secret);
                ...
                basicsServiceService basicsServiceServiceInstance = new basicsServiceService();
        device.addService("basicsService", basicsServiceServiceInstance);
        basicsServiceServiceInstance.enableAutoReport(10000);
