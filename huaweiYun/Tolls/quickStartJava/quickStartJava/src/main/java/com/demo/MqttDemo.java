...
public class MqttDemo {
    ...
    static String deviceId = "62d0c80f4c7c4e3646bac99e_demo002";
    static String secret = "wufan22722";
...
//        mqttDemo.connect(false); //false：mqtt连接示例
    ...
    private void publishMessage() {
        String jsonMsg = "{\"services\":[{\"service_id\":\"basicsService\",\"properties\":{\"BloodPressure\":%f},\"HeartRate\":%f},\"oxyhemoglobinSaturation\":%f}]}";

        String upMsg = String.format(jsonMsg, random.nextDouble()*140+60,random.nextDouble()*150+50,random.nextDouble()*0.2+0.9);
