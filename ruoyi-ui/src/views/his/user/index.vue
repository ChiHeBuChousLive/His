...
<script>
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/his/user";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除His用户信息编号为"' + userIds + '"的数据项？').then(function() {
