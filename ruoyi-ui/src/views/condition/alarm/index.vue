<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="alarmList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="警报Id" align="center" prop="alarmId" />
      <el-table-column label="是否通知诊所" align="center" prop="isNotice" />
      <el-table-column label="通知的诊所位置" align="center" prop="noticeClinicLocation" />
      <el-table-column label="帮助的老人设备位置" align="center" prop="helpEquipmentLocation" />
...
export default {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        alarmId: null,
        userEquipmentRelation: null,
        isNotice: null,
        noticeClinicLocation: null,
        helpEquipmentLocation: null,
        createBy: null,
        createTime: null,
        updateBy: null,
        updateTime: null,
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除设备警报管理编号为"' + alarmIds + '"的数据项？').then(function() {
